...
void Benchmark::SingleAllocation(AllocatorI* allocator, const std::size_t size, const std::size_t alignment) {
...
void Benchmark::SingleFree(AllocatorI* allocator, const std::size_t size, const std::size_t alignment) {
...
void Benchmark::MultipleAllocation(AllocatorI* allocator, const std::vector<std::size_t>& allocationSizes, const std::vector<std::size_t>& alignments) {
...
void Benchmark::MultipleFree(AllocatorI* allocator, const std::vector<std::size_t>& allocationSizes, const std::vector<std::size_t>& alignments) {
    assert(allocationSizes.size() == alignments.size() && "Allocation sizes and Alignments must have same length");
...
void Benchmark::RandomAllocation(AllocatorI* allocator, const std::vector<std::size_t>& allocationSizes, const std::vector<std::size_t>& alignments) {
...
void Benchmark::RandomFree(AllocatorI* allocator, const std::vector<std::size_t>& allocationSizes, const std::vector<std::size_t>& alignments) {
